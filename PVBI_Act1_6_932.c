...
Algoritmo que lee 3 calificaciones, saca el promedio y según el promedio, se estarán evaluando en un rango de promedio con if anidados (Anidado por el falso). 
